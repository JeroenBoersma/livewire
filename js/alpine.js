/**
 * This is a clone from alpinejs/src/index
 *
 * We will assign the evaluator in the final step
 * This way we can make sure to not include
 * the normalEvaluator in the CSP build
 *
 * Scripts in the livewire package should use
 * import Alpine from '@/alpine'
 *
 * this way we keep control on the Alpine code
 */
